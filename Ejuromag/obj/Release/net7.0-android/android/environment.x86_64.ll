...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"9348d684-c779-4b06-b0b4-6a512ff998a3\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [25 x i8] c"com.companyname.ejuromag\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100672341, ; jnienv_initialize_method_token
	i32 100672340, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.17 = internal constant [46 x i8] c"libaot-System.Threading.Tasks.Parallel.dll.so\00", align 16
...
@__DSOCacheEntry_name.33 = internal constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 16
@__DSOCacheEntry_name.34 = internal constant [41 x i8] c"libaot-Xamarin.AndroidX.ViewPager.dll.so\00", align 16
@__DSOCacheEntry_name.35 = internal constant [36 x i8] c"libaot-CommunityToolkit.Mvvm.dll.so\00", align 16
...
@__DSOCacheEntry_name.38 = internal constant [44 x i8] c"libaot-System.Collections.NonGeneric.dll.so\00", align 16
@__DSOCacheEntry_name.39 = internal constant [42 x i8] c"libaot-Xamarin.AndroidX.ViewPager2.dll.so\00", align 16
@__DSOCacheEntry_name.40 = internal constant [62 x i8] c"libaot-Microsoft.Extensions.Configuration.Abstractions.dll.so\00", align 16
@__DSOCacheEntry_name.41 = internal constant [42 x i8] c"libaot-Xamarin.AndroidX.SavedState.dll.so\00", align 16
@__DSOCacheEntry_name.42 = internal constant [55 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.LiveData.Core.dll.so\00", align 16
@__DSOCacheEntry_name.43 = internal constant [55 x i8] c"libaot-Xamarin.AndroidX.Security.SecurityCrypto.dll.so\00", align 16
@__DSOCacheEntry_name.44 = internal constant [43 x i8] c"libaot-Microsoft.Maui.Controls.Xaml.dll.so\00", align 16
@__DSOCacheEntry_name.45 = internal constant [23 x i8] c"libaot-Ejuromag.dll.so\00", align 16
...
@__DSOCacheEntry_name.51 = internal constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 16
...
@__DSOCacheEntry_name.56 = internal constant [41 x i8] c"libaot-CommunityToolkit.Maui.Core.dll.so\00", align 16
@__DSOCacheEntry_name.57 = internal constant [50 x i8] c"libaot-Xamarin.AndroidX.SwipeRefreshLayout.dll.so\00", align 16
@__DSOCacheEntry_name.58 = internal constant [51 x i8] c"libaot-Xamarin.AndroidX.Navigation.Fragment.dll.so\00", align 16
@__DSOCacheEntry_name.59 = internal constant [38 x i8] c"libaot-System.Numerics.Vectors.dll.so\00", align 16
...
@__DSOCacheEntry_name.65 = internal constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
@__DSOCacheEntry_name.66 = internal constant [36 x i8] c"libaot-CommunityToolkit.Maui.dll.so\00", align 16
...
@__DSOCacheEntry_name.73 = internal constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [530 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__DSOCacheEntry_name.40, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 42
	%struct.DSOCacheEntry {
	...
	; 46
	%struct.DSOCacheEntry {
		i64 1936294158488095781, ; hash 0x1adf19473958cc25, from name: Ejuromag
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.45, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 47
	%struct.DSOCacheEntry {
	...
	; 122
	%struct.DSOCacheEntry {
		i64 4654310475693023056, ; hash 0x40976eb7d20fdf50, from name: aot-Ejuromag
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.45, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 330
	%struct.DSOCacheEntry {
		i64 11644822572825696705, ; hash 0xa19ab86eddb9d9c1, from name: Ejuromag.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.45, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 356
	%struct.DSOCacheEntry {
		i64 12648733526514902772, ; hash 0xaf895420627ea6f4, from name: libaot-Ejuromag.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.45, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 437
	%struct.DSOCacheEntry {
		i64 15334771831996193902, ; hash 0xd4d00dbbedcc9c6e, from name: aot-Ejuromag.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.45, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 497
	%struct.DSOCacheEntry {
		i64 17440354724203308545, ; hash 0xf2089637fcf1a601, from name: libaot-Ejuromag
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.45, i32 0, i32 0), ; name
		i8* null; handle
	}, 
